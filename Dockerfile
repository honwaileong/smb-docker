...
RUN yum -y install --enablerepo powertools wget python3 python3-devel perl gcc-c++ lmdb-devel gnutls-devel gpgme-devel jansson-devel libarchive-devel libacl-devel openldap-devel pam-devel krb5-server texinfo zlib-devel perl-Parse-Yapp dbus-devel krb5-devel rpcgen python2-dns python2-dns bind-utils
